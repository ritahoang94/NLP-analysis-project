...
# 
new.w2v.model <- h2o.word2vec(model_id = 'w2v_e30_v200_w30_f0',words, sent_sample_rate = 0, epochs = 30,vec_size = 200,window_size = 30) #vec_size:min_word_freq:word_model:
...
model <- svm(label~., train_data, cost = 0.01, gamma =3.1 ,gpus=1, threads = 8,display=1)
